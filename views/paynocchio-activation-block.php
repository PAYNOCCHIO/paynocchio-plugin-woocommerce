        ...
        <?php if(is_user_logged_in()) { ?>
            <?php if (!get_user_meta(get_current_user_id(), 'paynoccio_wallet')) { ?>
                <div class="cfps-mb-10 lg:cfps-mb-20">
                    <img class="cfps-block !cfps-mx-auto"
                ...
                <div class="cfps-flex cfps-justify-center cfps-mb-10">
                    <button id="paynocchio_activation_button" type="button" class="cfps-btn-primary">
            ...
            <?php } else { ?>
                ...
                <div class="paynocchio-profile-block paynocchio-blue-badge cfps-mb-8">
                    <div class="cfps-grid cfps-grid-cols-[1fr_100px_200px_35px] cfps-gap-x-6">
                        ...
                        <a class="tab-switcher cfps-cursor-pointer" id="wallet_toggle" href="/paynocchio-account/">
